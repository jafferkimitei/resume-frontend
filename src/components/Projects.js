    ...
    <>
      ...
      <section className="projects bg-gray-900 text-white py-20 relative">
        <div className="container mx-auto px-4 relative">
          <h3 className="text-center mb-8 uppercase tracking-[20px] text-gray-500 text-2xl md:text-3xl lg:text-4xl">
            Projects
          </h3>
          ...
          <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80">
            {projects.map((project, i) => (
              <div
                key={i}
                className="w-screen flex-shrink-0 snap-center flex flex-col items-center justify-center p-10 md:p-20 h-screen"
              >
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="relative w-full max-w-[300px] flex justify-center"
                >
                  {project.viewLink ? (
